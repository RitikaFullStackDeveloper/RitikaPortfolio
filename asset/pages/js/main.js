document.addEventListener("DOMContentLoaded", () => {
  ...
  ScrollReveal().reveal(".project .inner-project", { ...scrollRevealOption, interval: 200 });
  ScrollReveal().reveal(".skills p, .skills .skill-div", { ...scrollRevealOption, interval: 200 });
  ScrollReveal().reveal(".contact__info p", { ...scrollRevealOption, interval: 200 });
